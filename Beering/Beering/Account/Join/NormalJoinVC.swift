...
class NormalJoinVC: UIViewController {
    ...
    func textFieldInit(){
        ...
        IDTextField.textColor = BeeringColor.Gray01
        IDTextField.borderStyle = .none
        IDTextFieldUnderLine.backgroundColor = BeeringColor.Gray01
        duplicateIDText.isHidden = true
        confirmPasswordUnderLine.backgroundColor = BeeringColor.Gray01
        
        passwordTextField.borderStyle = .none
        confirmPassword.borderStyle = .none
        confirmPassword.textColor = BeeringColor.Gray01
        passwordCharLimit.textColor = BeeringColor.Gray01
        passwordEngRegEx.textColor = BeeringColor.Gray01
        passwordNumRegEx.textColor = BeeringColor.Gray01
        passwordSpecialRegEx.textColor = BeeringColor.Gray01
        passwordTextFieldUnderLine.backgroundColor = BeeringColor.Gray01
        passwordTextField.textColor = BeeringColor.Gray01
        ...
        nikNameRegEx.textColor = BeeringColor.Gray01
        nikNameCharLimit.textColor = BeeringColor.Gray01
        nikNameTextFieldUnderLine.backgroundColor = BeeringColor.Gray01
        nikNameTextField.textColor = BeeringColor.Gray01
    ...
    @objc func checkValidNikName(){
        ...
        nikNameTextField.textColor = BeeringColor.Black
        nikNameCharLimit.isHidden = false
        nikNameRegEx.text = "영문/한글/숫자✓"
        
        if self.nikNameTextField.text!.count > 0{
            self.nikNameTextFieldUnderLine.backgroundColor = BeeringColor.Black
        }
        else{
            self.nikNameTextFieldUnderLine.backgroundColor = BeeringColor.Gray01
        }
        ...
        if checkNikNameRegEx(inputNikName: nikName, inputRegEx: nikRegEx){
            isRegEx = true
            self.nikNameRegEx.textColor = BeeringColor.Black
        }
        else{
            isRegEx = false
            self.nikNameRegEx.textColor = BeeringColor.Gray01
        }
        
        if nikName.count >= 1 && nikName.count <= 10{
            charLimit = true
            self.nikNameCharLimit.textColor = BeeringColor.Black
        }
        else {
            charLimit = false
            self.nikNameCharLimit.textColor = BeeringColor.Gray01
        }
        
        if isRegEx && charLimit{
            self.nikDupliCheckBtn.backgroundColor = BeeringColor.Black
            validNikName = true
        }
        else{
            self.nikDupliCheckBtn.backgroundColor = BeeringColor.Gray03
            validNikName = false
        }
    }
    ...
    @objc func checkValidPassword(){
        ...
        if password.count > 0{
            passwordTextFieldUnderLine.backgroundColor = BeeringColor.Black
        }
        else{
            passwordTextFieldUnderLine.backgroundColor = BeeringColor.Gray01
        }
        ...
        if engNum > 0{
            isEngRegEx = true
            passwordEngRegEx.textColor = BeeringColor.Black
        }
        else{
            isEngRegEx = false
            passwordEngRegEx.textColor = BeeringColor.Gray01
        ...
        if specialNum > 0 && (password.count == engNum + specialNum + numeral){
            isSpecailRegEx = true
            passwordSpecialRegEx.textColor = BeeringColor.Black
        }
        else{
        ...
        if numeral > 0 {
            isNumRegEx = true
            passwordNumRegEx.textColor = BeeringColor.Black
        }
        else{
            isNumRegEx = false
            passwordNumRegEx.textColor = BeeringColor.Gray01
        ...
        if password.count >= 8 && password.count <= 20{
            charLimit = true
            passwordCharLimit.textColor = BeeringColor.Black
        }
        else{
            charLimit = false
            passwordCharLimit.textColor = BeeringColor.Gray01
        ...
        if password.count != engNum + specialNum + numeral{
            validPassword = false
            passwordTextFieldUnderLine.backgroundColor = BeeringColor.Red
        }
        else{
            if isEngRegEx && isNumRegEx && isSpecailRegEx && charLimit{
                validPassword = true
                passwordTextFieldUnderLine.backgroundColor = BeeringColor.Green
            }
            else{
                validPassword = false
                passwordTextFieldUnderLine.backgroundColor = BeeringColor.Red
    ...
    @objc func checkValidID(){
        ...
        if ID.count > 0{
            self.IDTextFieldUnderLine.backgroundColor = BeeringColor.Black
        }
        else{
            self.IDTextFieldUnderLine.backgroundColor = BeeringColor.Gray01
        }
        ...
        if checkIDRegEx(inputID: ID, inputRegEx: emailRegEx) && ID.count > 4{
            validID = true
            IDcheckDupliBtn.backgroundColor = BeeringColor.Black
        }
        else{
            validID = false
            IDcheckDupliBtn.backgroundColor = BeeringColor.Gray03
    ...
    @objc func confirmSamePassword(){
        passwordTextField.isSecureTextEntry = true
        confirmPassword.textColor = BeeringColor.Black
        if passwordTextField.text == confirmPassword.text{
            samePassword = true
            confirmPasswordUnderLine.backgroundColor = BeeringColor.Green
            differentPasswordText.isHidden = true
        }
        else{
            confirmPasswordUnderLine.backgroundColor = BeeringColor.Red
            samePassword = false
    ...
    @objc func validJoinMembership(){
        if validPassword && validID && validNikName && termsOfUse1.isChecked && termsOfUse2.isChecked{
            if samePassword{
                joinMembershipBtn.backgroundColor = BeeringColor.Black
                validJoin = true
            }
            else{
                joinMembershipBtn.backgroundColor = BeeringColor.Gray03
...
//            let queryString :String = "?username"
            ...
            AF.request(url,
                ...
                case .success(let data):
                    do {
                        ...
                        print(self.isDuplicateID)
                        if self.isDuplicateID {
                            self.IDTextFieldUnderLine.backgroundColor = BeeringColor.Green
                            self.duplicateIDText.textColor = BeeringColor.Green
                            self.duplicateIDText.text = "사용할 수 있는 아이디예요"
                        }
                        else{
                            self.IDTextFieldUnderLine.backgroundColor = BeeringColor.Red
                            self.duplicateIDText.textColor = BeeringColor.Red
                            self.duplicateIDText.text = "이미 사용하고 있는 아이디예요"
                        }
                        print("#############")
                        print(duplicateID)
                    }
...
//            }
    ...
    @IBAction func nikDuplicateBtnTap(_ seder: Any){
        ...
        if validNikName{
            ...
            if isDuplicateNik{
                nikNameTextFieldUnderLine.backgroundColor = BeeringColor.Green
                
                nikNameRegEx.textColor = BeeringColor.Green
                nikNameRegEx.text = "사용할 수 있는 닉네임이에요"
            }
            else{
                nikNameTextFieldUnderLine.backgroundColor = BeeringColor.Red
                
                nikNameRegEx.textColor = BeeringColor.Red
